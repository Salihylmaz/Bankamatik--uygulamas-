...
public class form1 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql="SELECT * FROM kullanicilar WHERE username='"+KullaniciAdi+"'";
        String db5 ="SELECT * FROM kullanicilar WHERE username='"+KullaniciAdi +"' AND password='"+sifre+"'";
        String query = "SELECT * FROM kullanicilar WHERE username=? AND password=?";
        Session.getInstance().setKullaniciAdi(KullaniciAdi);
	try {
            ResultSet myRs2=sqldb.bul(sql);
            while(myRs2.next()) {
